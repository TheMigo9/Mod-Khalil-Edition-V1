...
function onEvent(eventName, val1, val2)
         if eventName == 'MattEchos' or eventName == 'BFEchos' then
            if val1 == 'shield' then
                   setProperty('boyfriend.cameraPosition[0]', 600)
                   setProperty('boyfriend.cameraPosition[1]', -20)
            end

            if val1 == 'backS' then
                   setProperty('boyfriend.cameraPosition[0]', 220)
                   setProperty('boyfriend.cameraPosition[1]', -20)
            end
         end
end